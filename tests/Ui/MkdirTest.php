...
class MkdirTest extends TestCase {
    ...
    public function it_creates_a_dir_that_doesnt_exist_yet() {
        ...
        $backend->shouldReceive('exec')->with('mkdir \'/home/user/new\' > /dev/null 2>&1; echo $?')->once()->andReturn('0\n');
    ...
    public function it_cannot_create_a_dir_when_return_code_is_false() {
        ...
        $backend->shouldReceive('exec')->with('mkdir \'/home/user/new\' > /dev/null 2>&1; echo $?')->once()->andReturn('1\n');
    ...
    public function it_can_create_a_dir_that_has_single_quotes() {
        ...
        $backend->shouldReceive('exec')->with("mkdir '/home/O'\''new' > /dev/null 2>&1; echo $?")->once();
